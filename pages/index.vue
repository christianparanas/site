<template>
  <div id="App" class="main">
    ...
    <div class="hero">
      ...
      <div class="options">
        <NuxtLink to="/projects" class="pr shadow-md cursor-pointer">
        ...
        <a href="/Curriculum Vitae.txt" download class="cv shadow-md cursor-pointer">
      ...
      <div class="can">
        <div class="shadow dev">
            <div class="svg">
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" enable-background="new 0 0 64 64" viewBox="0 0 64 64"><path fill="#133851" d="M63.376,3.638c-0.5-0.19-1.06,0.06-1.26,0.56l-0.8,2.1c-1.28,3.33-4.63,5.34-8.16,4.89
