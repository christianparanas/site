<template>
   <div id="Nav" class="nav p-4 flex">
      ...
      <div v-if="toggleMode" @click="$colorMode.preference = 'dark'; toggleMode = !toggleMode" class="menu-icon flex-initial w-10 p-1 border-4 border-transparent rounded-full cursor-pointer">
